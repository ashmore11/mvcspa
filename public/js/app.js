...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templatesCommonHeaderJade = __webpack_require__(11);

	var _templatesCommonHeaderJade2 = _interopRequireDefault(_templatesCommonHeaderJade);

	var _templatesCommonFooterJade = __webpack_require__(14);
	...
	var Controller = (function () {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function render() {
	      ...
	      var View = __webpack_require__(15)("./" + _appRouter2['default'].pageId);
	      var Template = __webpack_require__(18)("./" + _appRouter2['default'].pageId + '.jade');
	      var Data = _appRouter2['default'].data.page;
	    ...
	    value: function renderCommonElements() {
	      ...
	      var headerData = {
	        routes: _appRouter2['default'].routes,
	        data: _appRouter2['default'].data.header
	      };

	      body.prepend((0, _templatesCommonHeaderJade2['default'])(headerData));
	      body.append((0, _templatesCommonFooterJade2['default'])(_appRouter2['default'].data.footer));
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appModel = __webpack_require__(10);
	    ...
	    value: function start(ctx, data) {
	      ...
	      this.routes.map(function (route) {
	        ...
	        if (route.path === ctx.path) {
	          ...
	          _this2.pageId = route.id;
	          _this2.path = route.path;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jade_mixins = {};
	var jade_interp;
	;var locals_for_with = (locals || {});(function (data, routes, undefined) {
	buf.push("<div id=\"header\"><h2>" + (jade.escape((jade_interp = data.title) == null ? '' : jade_interp)) + "</h2><ul>");
	// iterate routes
	;(function(){
	  var $$obj = routes;
	...
	buf.push("<li><a" + (jade.attr("href", "" + (item.path) + "", true, false)) + ">" + (jade.escape((jade_interp = item.id) == null ? '' : jade_interp)) + "</a></li>");
	    }
	...
	buf.push("</ul></div>");}.call(this,"data" in locals_for_with?locals_for_with.data:typeof data!=="undefined"?data:undefined,"routes" in locals_for_with?locals_for_with.routes:typeof routes!=="undefined"?routes:undefined,"undefined" in locals_for_with?locals_for_with.undefined: false?undefined:undefined));;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div id=\"example\"><h1>" + (jade.escape((jade_interp = locals.title) == null ? '' : jade_interp)) + "</h1></div>");;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("<div id=\"home\"><h1>" + (jade.escape((jade_interp = locals.title) == null ? '' : jade_interp)) + "</h1></div>");;return buf.join("");
	}
