	...
	var Controller = (function () {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function render() {
	      ...
	      var View = __webpack_require__(17)("./" + _appRouter2['default'].pageId);
	      var Template = __webpack_require__(20)("./" + _appRouter2['default'].pageId + '.jade');
	      var Data = {
	        page: _appRouter2['default'].data.pages[_appRouter2['default'].pageId],
	        user: _appRouter2['default'].data.users[_appRouter2['default'].userId]
	      };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appModel = __webpack_require__(12);
