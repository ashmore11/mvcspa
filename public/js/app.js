...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appModel = __webpack_require__(1);
	...
	var App = (function () {
	  ...
	  _createClass(App, [{
	    ...
	    value: function bindEvents() {
	      ...
	      _appModel2['default'].on('data:loaded', function (data) {

	        _this.controller.init(data);
	      });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templatesCommonHeaderJade = __webpack_require__(9);

	var _templatesCommonHeaderJade2 = _interopRequireDefault(_templatesCommonHeaderJade);

	var _templatesCommonFooterJade = __webpack_require__(12);
	...
	var AppController = (function () {
	  ...
	  _createClass(AppController, [{
	    ...
	    value: function render() {
	      ...
	      var View = __webpack_require__(13)("./" + _appRouter2['default'].pageId);
	      var Template = __webpack_require__(16)("./" + _appRouter2['default'].pageId + '.jade');
	      var Data = this.data.pages[_appRouter2['default'].pageId];
	    ...
	    value: function renderCommonElements() {
	      ...
	      body.prepend((0, _templatesCommonHeaderJade2['default'])(_appRouter2['default'].routes));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Router = (function () {
	  function Router() {
	    ...
	    (0, _page2['default'])('*', this.start.bind(this));
	    ...
	    value: function start(ctx) {
	      ...
	      this.routes.map(function (route) {
	        ...
	        if (route.path === ctx.path) {
	          ...
	          _this.pageId = route.id;
	          _this.path = route.path;
	        }
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	buf.push("</ul></div>");}.call(this,"undefined" in locals_for_with?locals_for_with.undefined: false?undefined:undefined));;return buf.join("");
	}
